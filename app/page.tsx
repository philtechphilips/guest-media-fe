  ...
  return (
    <>
      {uploadPageActive ? (
        ...
        <main className="relative h-screen p-5 pr-0 pl-0 overflow-hidden">
          ...
          <div className="py-10 px-5">
            ...
            <p className="mt-8 text-white heading">
              Capture the Magic? Share your cherished moments with us by
              uploading your photos and videos of this unforgettable
              celebration. Let’s create lasting memories together.
            </p>
